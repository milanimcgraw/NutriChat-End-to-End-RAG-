...
def main():
    print_log("Starting NutriChat...")
    st.title("Your AI-powered Nutrition Facts Assistant")
    ...
    category = st.selectbox(
        ...
        ["Dairy products", "Meat, Poultry", "Fish, Seafood", 
         "Vegetables A-E", "Vegetables F-P", "Vegetables R-Z",
    ...
    model_choice = st.selectbox(
        "Select a model:",
        ["openai/gpt-3.5-turbo", "openai/gpt-4o", "openai/gpt-4o-mini"]
    )
    ...
    # User input
    user_input = st.text_input("Ask me about nutrition facts!")
    ...
    if st.button("Ask"):
        ...
        with st.spinner("Processing..."):
            ...
            answer_data = get_answer(user_input, category, model_choice, search_type)
            end_time = time.time()
            ...
            save_conversation(
                st.session_state.conversation_id, user_input, answer_data, category
            )
...
if __name__ == "__main__":
    print_log("Nutrition Facts Assistant started")
    main()