...
CATEGORIES = ["Dairy products", "Meat, Poultry", "Fish, Seafood", "Vegetables A-E", "Vegetables F-P", "Vegetables R-Z", "Fruits A-F", "Fruits G-P", "Fruits R-Z", "Breads, cereals, fastfood, grains", "Soups", "Desserts, sweets", "Jams, Jellies", "Seeds and Nuts", "Drinks, Alcohol, Beverages"]
